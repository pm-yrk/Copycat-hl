...
const staticLogoUrls: Record<string, string> = {
  ...
  AAVE:'/copycat-token-badges/aave.svg', TRX:'/copycat-token-badges/trx.svg', XRP:'/copycat-token-badges/xrp.svg', AVAX:'/copycat-token-badges/avax.svg', BNB:'/copycat-token-badges/bnb.svg', LINK:'/copycat-token-badges/link.svg', UNI:'/copycat-token-badges/uni.svg', LTC:'/copycat-token-badges/ltc.svg', DOT:'/copycat-token-badges/generic.svg', FIL:'/copycat-token-badges/generic.svg', ATOM:'/copycat-token-badges/generic.svg', NEAR:'/copycat-token-badges/generic.svg', ZEC:'/copycat-token-badges/generic.svg', ARB:'/copycat-token-badges/generic.svg', SUI:'/copycat-token-badges/generic.svg', OP:'/copycat-token-badges/generic.svg', APE:'/copycat-token-badges/generic.svg', INJ:'/copycat-token-badges/generic.svg', FET:'/copycat-token-badges/generic.svg'
}
